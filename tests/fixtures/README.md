...
| `radar_tile_z7_x64_y80_with_echo.png` | `docs/captures/radar_tile_2026-08-17T1330Z_z7_x64_y80_with_echo.png` | RadarGrid tile z=7, x=64, y=80, captured 2026-08-17 13:30Z. Genuine visible echo - a small blue/cyan/green/orange cluster plus scattered noise dots - captured while it was actually raining over Catalonia. Fills the gap `AGENTS.md` deferred: the 2x-scale radar anchor was previously only column-position-checked (`radar_tile_z7_x65_y80_no_echo.png` above had no echo at capture time), never checked against real echo pixel content. |
